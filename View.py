...
class View:
    ...
    def close_window(self):
        ...
        if result:
            ...
            messagebox.showinfo("Have a good day", "Thank you for using the app")
            self.top.destroy()
    ...
    def play_song(self):
        ...
        try:
            ...
            if self.isThreadRunning == False:
                ...
                self.stop_song()
                time.sleep(1)
            self.songProgress.configure(length=self.song_length, maximum=self.song_length)
            self.setup_thread()
    ...
    def remove_song(self):
        ...
        try:
            ...
            song_name = self.playList.get(self.sel_index_tuple)
    ...
    def load_song_from_favourites(self):
        try:
            ...
            mycolor = "#" + red + green + blue
            self.playList.config(fg=mycolor)
            messagebox.showinfo("Song Added!!", result_str)
        except DatabaseError as ex:
            messagebox.showinfo("DB Error", ex)
